...
C:\python27\python .\provide_script\source\script_createcpp.py .\provide_script\source

:: Run python scripts to generate JavaScript lib
C:\python27\python .\provide_script\source\script_create_std_js.py .\provide_script\source .\release
